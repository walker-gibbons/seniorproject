...
<button onclick="document.location='/mapproj/map.php'">Interactive Map</button>
...
<br>
<h1 style="border-left:solid 6px;border-color:red;">Program List Page Test</h1>
<div>This is a test page for the list of programs available within Mercer Abroad. I will also have a smaller, less comprehensive list on the page with the interactive map.</div><br><br>
</body>
